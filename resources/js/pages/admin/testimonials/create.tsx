...
export default function CreateTestimonial() {
    ...
    return (
        <>
            <Head title="New Business Story — Admin" />
            ...
            <div className="p-6 md:p-8 space-y-8 min-h-full">
                ...
                <div className="bg-primary text-white p-8 border border-border">
                    <div className="inline-flex items-center gap-2 mb-4">
                        ...
                        <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gold">New Story</span>
                    </div>
                    <h1 className="font-display text-3xl font-bold tracking-tight">Create Business Story</h1>
                    <p className="text-white/70 mt-2">Add a new success story from one of the businesses you serve.</p>
                </div>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-card border border-border rounded-xl p-8 space-y-6 sticky top-8">
                            ...
                            <div className="pt-6 border-t border-border">
                                ...
                                >
                                    {processing ? 'Saving...' : <><Save className="h-4 w-4 mr-2" /> Save Story</>}
                                </Button>
                            </div>
                        </div>
                    </div>
...
CreateTestimonial.layout = (page: any) => (
    <AppLayout breadcrumbs={[
        { title: 'Business Stories', href: '/admin/testimonials' },
        { title: 'New Story', href: '/admin/testimonials/create' }
    ]}>
        {page}
    </AppLayout>
);
