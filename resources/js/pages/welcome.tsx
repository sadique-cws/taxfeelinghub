    ...
    <PublicLayout>
        ...
        <div className="container-page relative grid gap-12 lg:grid-cols-[1.15fr_1fr] items-center py-10">
          <div className="animate-fade-up">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-md bg-gold px-7 py-3.5 font-semibold text-gold-foreground hover:opacity-90 transition-smooth shadow-soft"
              >
          ...
          <div className="relative">
            ...
            <div className="relative aspect-video rounded-2xl bg-white/5 backdrop-blur-sm border border-primary-foreground/10 shadow-elegant overflow-hidden flex items-center justify-center text-primary-foreground/10">
                [Hero Image Placeholder]
            </div>
            <div className="absolute -bottom-6 -left-6 hidden md:flex flex-col gap-1 rounded-xl bg-background text-foreground p-4 shadow-elegant border border-border">
          ...
          {SERVICES.map((s) => {
            ...
            return (
              <Link
                ...
                className="group relative flex flex-col rounded-xl border border-border bg-card p-6 hover-lift shadow-card"
              >
      ...
      <section className="bg-subtle-gradient">
        <div className="container-page py-20 md:py-28 grid gap-14 lg:grid-cols-2 items-center">
          <div className="relative">
            <div className="aspect-[4/3] rounded-2xl bg-muted overflow-hidden shadow-elegant flex items-center justify-center text-muted-foreground">
                [Team Excellence]
            </div>
            <div className="absolute -bottom-6 -right-6 hidden md:block rounded-xl bg-primary text-primary-foreground p-6 shadow-elegant max-w-[240px]">
      ...
      <section className="container-page py-20 md:py-28">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {TESTIMONIALS.map((t) => (
            <figure key={t.name} className="rounded-xl border border-border bg-card p-7 shadow-card transition-smooth hover:border-gold/30">
